            ...
            <Grid container spacing={3} justify="center">
                <Grid item xs={12} md={3} component={Card} className={cx(styles.card, styles.infected)}>
                    <CardContent>
                        ...
                        <Typography variant="body2">Número de casos ativos pela Covid-19</Typography>
                    </CardContent>
                </Grid>
                ...
                <Grid item xs={12} md={3} component={Card} className={cx(styles.card, styles.recovered)}>
                    <CardContent>
                        ...
                        <Typography color="textSecondary">{new Date(lastUpdate).toDateString()}</Typography>
                        <Typography variant="body2">Número de casos recuperados pela Covid-19</Typography>
                    </CardContent>
                </Grid>
                ...
                <Grid item xs={12} md={3} component={Card} className={cx(styles.card, styles.deaths)}>
                    <CardContent>
                        ...
                        <Typography color="textSecondary">{new Date(lastUpdate).toDateString()}</Typography>
                        <Typography variant="body2">Número de mortes causadas pela Covid-19</Typography>
                    </CardContent>
                </Grid>
            </Grid>
        </div>
